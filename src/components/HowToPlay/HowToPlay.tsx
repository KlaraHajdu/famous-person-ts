...
import { selectModalOpened } from "../../store/slices/gamePhase/gamePhaseSelector";
import { gamePhaseActions } from "../../store/slices/gamePhase/slice";

export default function HowToPlay() {
    const howToPlayModalOpen = useSelector(selectModalOpened);
    ...
    return (
        <Modal
            ...
            onHide={() => dispatch(gamePhaseActions.HOWTOPLAYMODAL_TOGGLED(false))}
            ...
            <Modal.Body>
                <div className="modal-background-color">
                    ...
                    <p>
                        ...
                        In the first round the players explain the persons in detail, without telling the name. In the
                        second round the players are only allowed to say a single word, which will help their teammates
                        to guess the person. In the third round the player on turn can only pantomime without saying
                        anything. After the three rounds the team with higher scores wins.
                    </p>
                    <p>
